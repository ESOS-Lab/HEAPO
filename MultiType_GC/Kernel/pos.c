...
//기능: 객체 저장소에서 사용하는 자료구조 타입 및 자료구조 딕셔너리 정보를 기록하는 시스템 콜 함수
//입력 값
//	obj_storage_name : 객체 저장소 이름
//	type : 객체 저장소에 구성될 자료구조 타입(Btree, Hashtable, Linked-List)
//	size : Key 또는 Value 사이즈
//	key : 노드 내 Key 개수
//	value : 노드 내 value 개수
...
//기능 : 객체 저장소에 구성된 자료구조 타입 및 딕셔너리 정보를 반환하는 시스텤 콜 함수
//입력 값
//	obj_storage_name : 객체 저장소 이름
//	type : 자료구조 타입 및 딕셔너리 정보를 반환할 포인터 변수
...
//기능 : SFGC에서 접근하는 Unmapped List에서 Unmap된 10개(default)의 객체 저장소를 반환하는
//	시스템 콜 함수
//입력 값: vimtim_list는 Unmap된 10개의 객체 저장소를 반환할 List의 head

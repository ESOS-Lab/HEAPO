/*
  	...
  	This program is to create the number of object store input second with the name according to second input. It can be used to check SFGC behavior.

	Input 	: ./create_objs [Object Name] [Num of Objects] [Num of Nodes] [Num of Garbages]
	Example : ./create_objs ObjectA 20 100 50
	by 손성배
*/
...
int main(int argc, char *argv[])
{
	...
	for(k=0; k<num_of_pos; k++) {
		...
		pos_delete_selected_node(pos_name_arr[k], gc_idx-1);

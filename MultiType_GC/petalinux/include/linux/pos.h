...
//#define POS_AREA_SIZE			0x1000000000				// 64GB
...
//POS (Seongbae Son)
//#define POS_AREA_START			0x5FFEF8000000
//#define POS_AREA_END			0x7FFEF8000000
//#define POS_AREA_START			0x7000000000
//#define POS_AREA_END			0x8000000000
//#define POS_AREA_START			0x2000000000
//#define POS_AREA_END			0x3000000000

//#define POS_AREA_SIZE   	        0x3C00000000           // 64GB 
//#define POS_AREA_START                  (TASK_SIZE - min_gap() - POS_AREA_SIZE)
//#define POS_AREA_END			(POS_AREA_START + POS_AREA_SIZE)

#define POS_AREA_SIZE			0x40000000				// 1GB
#define POS_AREA_START			(TASK_SIZE-0x04000000-POS_AREA_SIZE)	// 0x5FFEF8000000
#define POS_AREA_END 			(POS_AREA_START+POS_AREA_SIZE)			// 0x7FFEF8000000

//#define POS_AREA_START			0x4C0000000
//#define POS_AREA_END			0x880000000
//#define POS_AREA_SIZE			0x3C0000000
//#define POS_AREA_START			0xFFFFFFF4C0000000
//#define POS_AREA_END			0xFFFFFFF880000000
...
struct pos_map_array
{
	...
	unsigned long pfns[POS_MAP_NR];	// last level¿Ã æ∆¥— ∞ÊøÏø£ ∆˜¿Œ≈Õ∑Œ ∫Ø»Øµ 
};
...
struct pos_vm_area
{
	...
	struct rb_node vm_rb;			//¿¸√º vmaø° ¥Î«— rb-tree
	struct pos_vm_area *vm_next;		//¿¸√º vmaø° ¥Î«— list
	struct list_head vm_next2;		//«œ≥™¿« object storageø° ∆˜«‘µ» vmaø° ¥Î«— list
};
...
struct pos_descriptor
{
	...
	fmode_t d_mode;
	//POS (Seongbae Son)
        short obj_storage_type;                 //Multi Type GC øøø øø øøø øøøø ø>ø
...
struct pos_superblock
{
	...
	//POS (Seongbae Son)
	struct list_head gc_list;		//SFGC ø Unmapped List head
};

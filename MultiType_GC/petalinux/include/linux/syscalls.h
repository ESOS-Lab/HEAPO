...
//POS (Seongbae Son)
asmlinkage long sys_pos_set_storage_type(char* obj_storage_name, int* type, int* size, int* key, int* value);
asmlinkage long sys_pos_get_storage_type(char *obj_storage_name, short *type);
asmlinkage long sys_pos_get_sfgc_list(char **victim_list);
#endif

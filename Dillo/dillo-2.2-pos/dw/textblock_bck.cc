...
//POS (Changhun Jung)
   ...
   //printf("sizeof SimpleVector : %d\n",sizeof(misc::SimpleVector));
   //printf("sizeof SimpleVector <Word> : %d\n",sizeof(misc::SimpleVector <Word>));
   ...
   //printf("[POS] words address=0x%lX\n", (unsigned long)words);
                         ...
                         core::style::Style *style)
{
   ...
   char *newchar;
#ifndef __POS_MODE
   //printf("before textzone->strndup\n");
   word->content.text = layout->textZone->strndup(text, len);
   //printf("after textzone->strndup\n");
#endif
#ifdef __POS_MODE
/////////////mapping/////////
   //if(pos_map("object") == 0)
/*
   ...
   {
	printf("pos_map error\n");
	return; 
   }
*/
   //newchar = (char *)pos_malloc("object",len+1);

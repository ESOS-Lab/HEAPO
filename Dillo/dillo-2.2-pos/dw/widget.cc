...
void Widget::queueDrawArea (int x, int y, int width, int height)
{
   ...
   // POS (Changhun Jung)
   #if DEBUG == 1
	   printf(" In Widget::queueDrawArea\n");
   #endif
...
{
   // POS (Changhun Jung)
   // printf("&this widget: 0x%lX\n",this); 
   // printf("&Widget->Layout: 0x%lX\n",getLayout()); 
   ...
   if (needsAllocate () ||
	  ...
	  //printf("before wasAllocated()\n"); // POS (Changhun Jung)
	  
      if (wasAllocated ()) {
  	 
	// POS (Changhun Jung)
	#if 0
		 printf("this->allocation.x:%d\n",this->allocation.x);
		 printf("this->allocation.y:%d\n",this->allocation.y);
		 printf("this->allocation.width:%d\n",this->allocation.width);
		 printf("this->allocation.ascent + this->allocation.descent,:%d\n",this->allocation.ascent + this->allocation.descent);
		 
		 printf("allocation.x: %d\n",allocation->x);
		 printf("allocation.y: %d\n",allocation->y);
		 printf("allocation.width: %d\n",allocation->width);
		 printf("allocation.ascent + allocation.descent,: %d\n",allocation->ascent + allocation->descent);		 
	#endif		 
	  ...
	  //printf("before sizeAllocateImpl()\n"); // POS (Changhun Jung)
      sizeAllocateImpl (allocation);
	  //printf("after sizeAllocateImpl()\n"); // POS (Changhun Jung)
	  ...
	  //printf("before resizeDrawImpl()\n"); // POS (Changhun Jung)
      resizeDrawImpl ();
	  //printf("after resizeDrawImpl()\n"); // POS (Changhun Jung)
...
{ 
   ...
   // printf("after updateCursor\n"); // POS (Changhun Jung)  
   if (sizeChanged)
      queueResize (0, true);
   else
      queueDraw ();
   // printf("after queueDraw\n"); // POS (Changhun Jung)

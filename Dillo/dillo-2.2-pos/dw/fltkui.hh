...
public:
   ...
   // POS (Changhun Jung)
   inline void setPlatform(FltkPlatform *platform){this->platform = platform;}	
...
public:
   ...
   // POS (Changhun Jung)
   void setPlatformImpl(dw::core::Platform *platform)      
   {		
		//printf("FltkLabelButton::setplatformImpl\n");
		//printf(" &resource: 0x%lX\n",(FltkResource *)this);
		//printf(" &platform: 0x%lX\n",platform);
		//((FltkPlatform *)platform )->attachResource(this);
		((FltkPlatform *)platform )->attachResource((FltkResource *)this);
		//((FltkResource *)this)->platform = platform;
		((FltkResource *)this)->setPlatform((FltkPlatform *)platform);
   }
};
...
public:
   ...
   {		
		#if (DEBUG == 1)
		   printf("FltkComplexButton::setplatformImpl\n");
		#endif
		//printf(" &resource: 0x%lX\n",(FltkResource *)this);
		//printf(" &platform: 0x%lX\n",platform);
		//((FltkPlatform *)platform )->attachResource(this);
		...
		((FltkResource *)this)->setPlatform((FltkPlatform *)platform);
		((FltkPlatform *)platform )->attachResource((FltkResource *)this);		
		((dw::core::ui::ComplexButtonResource *)this)->init(((dw::core::ui::ComplexButtonResource *)this)->widget);		
...
public:
   ...
   void setPlatformImpl(dw::core::Platform *platform)      
   {		
		printf("FltkMultiLineTextResource::setplatformImpl\n");
		printf(" &resource: 0x%lX\n",(FltkResource *)this);
		printf(" &platform: 0x%lX\n",platform);
		//((FltkPlatform *)platform )->attachResource(this);
		((FltkPlatform *)platform )->attachResource((FltkResource *)this);

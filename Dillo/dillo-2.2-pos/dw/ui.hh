...
public:
   ...
   void setPlatform(Platform *platform); //POS (Changhun Jung)
...
private:
   ...
   public:
      inline ActivateEmitter(){}
	  //inline ActivateEmitter(bool IsPos) : Emitter(1){} // POS (Changhun Jung)
...
protected:
   ...
   //virtual void setEmbed (Embed *embed); //POS (Changhun Jung)
...
public:
   ...
   //POS (Changhun Jung)
   virtual void setPlatformImpl(dw::core::Platform *platform)
   {
   		// POS (Changhun Jung)
   		#if (DEBUG == 1)
	   		printf("setPlatformImpl\n");
		#endif
   }
...
private:
   ...
   //Widget *widget; //POS (Changhun Jung)
...
protected:
   ...
   //void init (Widget *widget); //POS (Changhun Jung)
...
public:
   ...
   void init (Widget *widget); //POS (Changhun Jung)
   //POS (Changhun Jung)
   void setLayoutReceiver()
   {
		layoutReceiver.resource = this;
   }
   
   void setLayoutReceiver(LayoutReceiver *_layoutReceiver)
   {
		memcpy(&layoutReceiver, _layoutReceiver, sizeof(LayoutReceiver) );
		layoutReceiver.resource = this;
   }

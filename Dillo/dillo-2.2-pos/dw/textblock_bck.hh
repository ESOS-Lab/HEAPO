...
public:
   ...
   { 
    printf("address of this: %X\n",this);
	words->_print();
	Word *word = words->getRef(wordIndex);
	printf("after words->getRef(wordIndex)\n");
	printf("word[%d]' address : 0x%lX\n",wordIndex, (unsigned long)word);
	//printf("word[%d]' type : %d\n",wordIndex, word->content.type);

...
#endif 
#ifdef __POS_MODE
         _style = new Style (attrs);
	 style = (Style*)pos_malloc(__POS_OBJ_NAME,sizeof(Style)); //added by POS [JCH]
	 //printf("after pos_malloc\n");
	 memcpy(style, _style, sizeof(Style)); //added by POS [JCH]
	 //printf("after memcpy\n");
#endif
         styleTable->put(style, style);//[POS] removed by [JCH]
	 //printf("after put\n");

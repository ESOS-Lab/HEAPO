...
// POS (Changhun Jung)   
   ...
   {
		_hscrollbar = new Scrollbar (0, 0, 1, 1);
		hscrollbar = (Scrollbar*)pos_malloc(__POS_OBJ_NAME, sizeof(Scrollbar) );
		memcpy(hscrollbar ,_hscrollbar , sizeof(Scrollbar) );
   }
#endif
...
// POS (Changhun Jung)   
   ...
   {
		_vscrollbar = new Scrollbar (0, 0, 1, 1);
		vscrollbar = (Scrollbar*)pos_malloc(__POS_OBJ_NAME, sizeof(Scrollbar) );
		memcpy(vscrollbar ,_vscrollbar , sizeof(Scrollbar) );
   } 
#endif

...
private:
   ...
   /**
   * \brief Pointer of memeber function
   */
   void (dw::core::Widget::*fpr)(int); // POS (Changhun Jung)
...
protected:
   ...
   {
	   #if (DEBUG == 1)
		   printf("before widget::setCursor\n"); 
	   #endif
...
public:
   ...
   // POS (Changhun Jung)
   virtual void printAll(void){printf("Widget::printAll\n"); };   
   virtual void setPlatform(Platform *platform)
   {
   		// POS (Changhun Jung)
   		#if (DEBUG == 1)
	   		printf("Widget::setPlatform \n");
		#endif
   }
   virtual void setChildLayout(){};   
   virtual void _setLayout(){this->layout = parent-> layout;};
   //virtual void countWidget(){};

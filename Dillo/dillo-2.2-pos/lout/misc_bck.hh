...
//public: //[POS] modified by JCH
   ...
   inline void resize ()
   {
...
#ifdef __POS_MODE
	 //this->array = (T*) pos_malloc ("object",sizeof (T));
	 ...
	 {
		printf("pos_malloc word success\n");
	 }
#endif
...
#ifdef __POS_MODE
		 this->array =
            //(T*) pos_realloc("object",this->array, (this->numAlloc * sizeof (T)));
...
public:  //[POS] removed by JCH for some time

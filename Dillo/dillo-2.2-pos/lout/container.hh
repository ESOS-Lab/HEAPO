...
public:
   ...
   inline List(bool ownerOfObjects, bool IsPos)
   { 
   		// POS (Changhun Jung)
   		untyped::Collection *_base;   		
		_base = new untyped::List(ownerOfObjects);
		this->base = (untyped::List *)pos_malloc(__POS_OBJ_NAME, sizeof(untyped::List) );
		memcpy(this->base, _base, sizeof(untyped::List) );
		((untyped::List *)this->base)->set_IsPos(1);
   }

...
cp pos-btree.h /usr/include/ &&
gcc -fPIC -c -o pos-lib.o pos-lib.c &&
gcc -fPIC -c -o pos-log.o pos-log.c &&
gcc -fPIC -c -o pos-malloc.o pos-malloc.c &&
gcc -fPIC -c -o pos-btree.o pos-btree.c &&
gcc -shared -Wl,-soname,libpos.so.0 -o libpos.so.0.0.0 pos-lib.o pos-log.o pos-malloc.o pos-btree.o &&

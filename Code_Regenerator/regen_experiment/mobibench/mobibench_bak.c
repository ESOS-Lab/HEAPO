...
int num_threads __attribute__ ((section("POS"))) ;
char pathname[128] = {0, };
int db_test_enable;
int db_mode __attribute__ ((section("POS"))) ;
int db_transactions __attribute__ ((section("POS"))) ;
int db_journal_mode;
int db_sync_mode;
int db_init_show = 0;
int db_interval  __attribute__ ((section("POS"))) = 0;
int g_state = 0;
char* g_err_string;
int b_quiet  __attribute__ ((section("POS"))) = 0;
...
int Latency_state  __attribute__ ((section("POS"))) = 0; // flag for printing latency
FILE* Latency_fp; // latency output
char REPORT_Latency[200]; // file name for latency output
int print_IOPS  __attribute__ ((section("POS"))) = 0; // flag for printing IOPS every second
...
unsigned long s_CPUTick[2][6] __attribute__ ((section("POS"))) ; 
...
char j_p_name[100] = {0, };
unsigned int j_nr_switches[2] __attribute__ ((section("POS")))  = {0, };
	 ...
	 if(flag)
	 {
...

		{
			...
			if(x < 1)
			{
	 		...
	 		{
		if(stmp < 0x7FFEF8000000 && stmp >= 0x5FFEF8000000){
			pos_free("mobibench_obj",stmp);
		}else{
				if(stmp < 0x7FFEF8000000 && stmp >= 0x5FFEF8000000){
		pos_free(",stmp);
	}else{
...
int init_file(char* filename, long long size)
{
	...
	//printf("\ninit end\n");
		...
		{
		if(buf < 0x7FFEF8000000 && buf >= 0x5FFEF8000000){
			pos_free("mobibench_obj",buf);
		}else{
				if(buf < 0x7FFEF8000000 && buf >= 0x5FFEF8000000){
		pos_free(",buf);
	}else{
...
//	printf("T%d end\n", thread_num);
	...
	if(g_sync == MMAP || g_sync == MMAP_AS || g_sync == MMAP_S)
	 ...
	 close(fd);
	 	...
	 	{
		if(org_buf < 0x7FFEF8000000 && org_buf >= 0x5FFEF8000000){
			pos_free("mobibench_obj",org_buf);
		}else{
				if(org_buf < 0x7FFEF8000000 && org_buf >= 0x5FFEF8000000){
		pos_free(",org_buf);
	}else{
 	...
 	if(recnum)
			{
		if(recnum < 0x7FFEF8000000 && recnum >= 0x5FFEF8000000){
			pos_free("mobibench_obj",recnum);
		}else{
				if(recnum < 0x7FFEF8000000 && recnum >= 0x5FFEF8000000){
		pos_free(",recnum);
	}else{
	...
	if(tmp_recnum)
			{
		if(tmp_recnum < 0x7FFEF8000000 && tmp_recnum >= 0x5FFEF8000000){
			pos_free("mobibench_obj",tmp_recnum);
		}else{
				if(tmp_recnum < 0x7FFEF8000000 && tmp_recnum >= 0x5FFEF8000000){
		pos_free(",tmp_recnum);
	}else{
...
int replay_script(void)
{
	...
	*/
		{
		if(script_write_buf < 0x7FFEF8000000 && script_write_buf >= 0x5FFEF8000000){
			pos_free("mobibench_obj",script_write_buf);
		}else{
				if(script_write_buf < 0x7FFEF8000000 && script_write_buf >= 0x5FFEF8000000){
		pos_free(",script_write_buf);
	}else{
			if(script_write_buf < 0x7FFEF8000000 && script_write_buf >= 0x5FFEF8000000){
		pos_free(",script_write_buf);
	}else{
			{
		if(script_write_buf < 0x7FFEF8000000 && script_write_buf >= 0x5FFEF8000000){
			pos_free("regen_obj",script_write_buf);
		}else{
				if(script_write_buf < 0x7FFEF8000000 && script_write_buf >= 0x5FFEF8000000){
		pos_free(",script_write_buf);
	}else{
		...
		{
		if(script_read_buf < 0x7FFEF8000000 && script_read_buf >= 0x5FFEF8000000){
			pos_free("mobibench_obj",script_read_buf);
		}else{
				if(script_read_buf < 0x7FFEF8000000 && script_read_buf >= 0x5FFEF8000000){
		pos_free(",script_read_buf);
	}else{
			if(script_read_buf < 0x7FFEF8000000 && script_read_buf >= 0x5FFEF8000000){
		pos_free(",script_read_buf);
	}else{
			{
		if(script_read_buf < 0x7FFEF8000000 && script_read_buf >= 0x5FFEF8000000){
			pos_free("regen_obj",script_read_buf);
		}else{
				if(script_read_buf < 0x7FFEF8000000 && script_read_buf >= 0x5FFEF8000000){
		pos_free(",script_read_buf);
	}else{
		...
		{
		if(gScriptFdConv.fd_org < 0x7FFEF8000000 && gScriptFdConv.fd_org >= 0x5FFEF8000000){
			pos_free("mobibench_obj",gScriptFdConv.fd_org);
		}else{
				if(gScriptFdConv.fd_org < 0x7FFEF8000000 && gScriptFdConv.fd_org >= 0x5FFEF8000000){
		pos_free(",gScriptFdConv.fd_org);
	}else{
			if(gScriptFdConv.fd_org < 0x7FFEF8000000 && gScriptFdConv.fd_org >= 0x5FFEF8000000){
		pos_free(",gScriptFdConv.fd_org);
	}else{
			{
		if(gScriptFdConv.fd_org < 0x7FFEF8000000 && gScriptFdConv.fd_org >= 0x5FFEF8000000){
			pos_free("regen_obj",gScriptFdConv.fd_org);
		}else{
				if(gScriptFdConv.fd_org < 0x7FFEF8000000 && gScriptFdConv.fd_org >= 0x5FFEF8000000){
		pos_free(",gScriptFdConv.fd_org);
	}else{
		...
		{
		if(gScriptFdConv.fd_new < 0x7FFEF8000000 && gScriptFdConv.fd_new >= 0x5FFEF8000000){
			pos_free("mobibench_obj",gScriptFdConv.fd_new);
		}else{
				if(gScriptFdConv.fd_new < 0x7FFEF8000000 && gScriptFdConv.fd_new >= 0x5FFEF8000000){
		pos_free(",gScriptFdConv.fd_new);
	}else{
			if(gScriptFdConv.fd_new < 0x7FFEF8000000 && gScriptFdConv.fd_new >= 0x5FFEF8000000){
		pos_free(",gScriptFdConv.fd_new);
	}else{
			{
		if(gScriptFdConv.fd_new < 0x7FFEF8000000 && gScriptFdConv.fd_new >= 0x5FFEF8000000){
			pos_free("regen_obj",gScriptFdConv.fd_new);
		}else{
				if(gScriptFdConv.fd_new < 0x7FFEF8000000 && gScriptFdConv.fd_new >= 0x5FFEF8000000){
		pos_free(",gScriptFdConv.fd_new);
	}else{
		...
		{
		if(thread_id < 0x7FFEF8000000 && thread_id >= 0x5FFEF8000000){
			pos_free("mobibench_obj",thread_id);
		}else{
				if(thread_id < 0x7FFEF8000000 && thread_id >= 0x5FFEF8000000){
		pos_free(",thread_id);
	}else{
		...
		{
		if(thread_info < 0x7FFEF8000000 && thread_info >= 0x5FFEF8000000){
			pos_free("mobibench_obj",thread_info);
		}else{
				if(thread_info < 0x7FFEF8000000 && thread_info >= 0x5FFEF8000000){
		pos_free(",thread_info);
	}else{
			if(thread_info < 0x7FFEF8000000 && thread_info >= 0x5FFEF8000000){
		pos_free(",thread_info);
	}else{
			{
		if(thread_info < 0x7FFEF8000000 && thread_info >= 0x5FFEF8000000){
			pos_free("regen_obj",thread_info);
		}else{
				if(thread_info < 0x7FFEF8000000 && thread_info >= 0x5FFEF8000000){
		pos_free(",thread_info);
	}else{
	...
	{	
			{
		if(gScriptEntry[i].cmd < 0x7FFEF8000000 && gScriptEntry[i].cmd >= 0x5FFEF8000000){
			pos_free("mobibench_obj",gScriptEntry[i].cmd);
		}else{
				if(gScriptEntry[i].cmd < 0x7FFEF8000000 && gScriptEntry[i].cmd >= 0x5FFEF8000000){
		pos_free(",gScriptEntry[i].cmd);
	}else{
			if(gScriptEntry[i].cmd < 0x7FFEF8000000 && gScriptEntry[i].cmd >= 0x5FFEF8000000){
		pos_free(",gScriptEntry[i].cmd);
	}else{
			{
		if(gScriptEntry[i].cmd < 0x7FFEF8000000 && gScriptEntry[i].cmd >= 0x5FFEF8000000){
			pos_free("regen_obj",gScriptEntry[i].cmd);
		}else{
				if(gScriptEntry[i].cmd < 0x7FFEF8000000 && gScriptEntry[i].cmd >= 0x5FFEF8000000){
		pos_free(",gScriptEntry[i].cmd);
	}else{
		...
		{
				{
		if(gScriptEntry[i].args[j] < 0x7FFEF8000000 && gScriptEntry[i].args[j] >= 0x5FFEF8000000){
			pos_free("mobibench_obj",gScriptEntry[i].args[j]);
		}else{
				if(gScriptEntry[i].args[j] < 0x7FFEF8000000 && gScriptEntry[i].args[j] >= 0x5FFEF8000000){
		pos_free(",gScriptEntry[i].args[j]);
	}else{
			if(gScriptEntry[i].args[j] < 0x7FFEF8000000 && gScriptEntry[i].args[j] >= 0x5FFEF8000000){
		pos_free(",gScriptEntry[i].args[j]);
	}else{
			{
		if(gScriptEntry[i].args[j] < 0x7FFEF8000000 && gScriptEntry[i].args[j] >= 0x5FFEF8000000){
			pos_free("regen_obj",gScriptEntry[i].args[j]);
		}else{
				if(gScriptEntry[i].args[j] < 0x7FFEF8000000 && gScriptEntry[i].args[j] >= 0x5FFEF8000000){
		pos_free(",gScriptEntry[i].args[j]);
	}else{
		...
		{
		if(gScriptEntry < 0x7FFEF8000000 && gScriptEntry >= 0x5FFEF8000000){
			pos_free("mobibench_obj",gScriptEntry);
		}else{
				if(gScriptEntry < 0x7FFEF8000000 && gScriptEntry >= 0x5FFEF8000000){
		pos_free(",gScriptEntry);
	}else{
			if(gScriptEntry < 0x7FFEF8000000 && gScriptEntry >= 0x5FFEF8000000){
		pos_free(",gScriptEntry);
	}else{
			{
		if(gScriptEntry < 0x7FFEF8000000 && gScriptEntry >= 0x5FFEF8000000){
			pos_free("regen_obj",gScriptEntry);
		}else{
				if(gScriptEntry < 0x7FFEF8000000 && gScriptEntry >= 0x5FFEF8000000){
		pos_free(",gScriptEntry);
	}else{
		...
		{
		if(gScriptThreadTime < 0x7FFEF8000000 && gScriptThreadTime >= 0x5FFEF8000000){
			pos_free("mobibench_obj",gScriptThreadTime);
		}else{
				if(gScriptThreadTime < 0x7FFEF8000000 && gScriptThreadTime >= 0x5FFEF8000000){
		pos_free(",gScriptThreadTime);
	}else{
			if(gScriptThreadTime < 0x7FFEF8000000 && gScriptThreadTime >= 0x5FFEF8000000){
		pos_free(",gScriptThreadTime);
	}else{
			{
		if(gScriptThreadTime < 0x7FFEF8000000 && gScriptThreadTime >= 0x5FFEF8000000){
			pos_free("regen_obj",gScriptThreadTime);
		}else{
				if(gScriptThreadTime < 0x7FFEF8000000 && gScriptThreadTime >= 0x5FFEF8000000){
		pos_free(",gScriptThreadTime);
	}else{
...
{
	if(pos_create("regen_obj") < 1){ 
		if(pos_map("regen_obj") < 1){
			return 0;
		} 
	}
	if(pos_create("regen_obj") < 1){ 
	...
	if(pos_create("mobibench_obj") < 1){ 
		if(pos_map("mobibench_obj") < 1){
			return 0;
		} 
	}
	int ret = 0;

...
*/
/* ARM */ 
#define ATOMIC_CAS_FULL(a,e,v)		(AO_compare_and_swap(a,e,v))
#define ATOMIC_FETCH_INC_FULL(a)	(AO_fetch_and_add(a,1))
#define ATOMIC_FETCH_DEC_FULL(a)	(AO_fetch_and_sub1(a))
#define ATOMIC_FETCH_ADD_FULL(a,v)	(AO_fetch_and_add(a,v)) 

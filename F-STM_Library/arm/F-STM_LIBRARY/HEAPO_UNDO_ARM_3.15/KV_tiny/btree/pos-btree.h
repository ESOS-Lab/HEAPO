...
//		   unsigned long *key);
void *pos_btree_lookup(char *name, void *key);
...
int pos_btree_insert(char *name, void *key, void *val, unsigned long val_size);
...
//int pos_btree_update(char *name, void *key, void *val, unsigned long val_size);
